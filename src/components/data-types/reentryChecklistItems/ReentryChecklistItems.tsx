...
import { SortableReentryChecklistItemsList } from "./SortableReentryChecklistItemsList";
import { z } from "zod";

export default function ReentryChecklistItems({
	items,
}: {
	...
	return (
		<div className="overflow-x-auto text-center">
			<div className="inline-block min-w-[950px] sm:min-w-[1150px] text-left">
				...
				{/* Table rows */}
				<SortableReentryChecklistItemsList items={items} />
			</div>
		</div>
	);
}
