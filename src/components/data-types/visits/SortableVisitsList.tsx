...
import { removeVisit, updateVisitOrders } from "@/tableInteractions/actions";
import { DialogTrigger } from "@/components/ui/dialog";
import { generalSchema, updateSchema } from "@/tableInteractions/schemas";
import { z } from "zod";
import VisitsFormDialog from "./VisitsFormDialog";

export function SortableVisitsList({
	items,
}: {
	...
	return (
		<SortableList items={items} onOrderChange={updateVisitOrders}>
			{(sorted) =>
							...
							>
								...
								<div className="flex justify-end gap-2">
									...
									<ActionButton
										...
										action={removeVisit.bind(null, item.id)}
										requireAreYouSure
									>
