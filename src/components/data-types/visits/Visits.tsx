...
import { z } from "zod";
import { SortableVisitsList } from "./SortableVisitsList";

export default function Visits({ items }: { items: (z.infer<typeof generalSchema> & z.infer<typeof updateSchema>)[] }) {
	return (
		<div className="overflow-x-auto text-center">
			<div className="inline-block min-w-[950px] sm:min-w-[1150px] text-left">
				...
				{/* Table rows */}
				<SortableVisitsList items={items} />
			</div>
		</div>
	);
}
