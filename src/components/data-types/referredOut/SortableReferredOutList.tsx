...
import { removeReferredOut, updateReferredOutOrders } from "@/tableInteractions/actions";
import { DialogTrigger } from "@/components/ui/dialog";
import { generalSchema, updateSchema } from "@/tableInteractions/schemas";
import { z } from "zod";
import ReferredOutFormDialog from "./ReferredOutFormDialog";

export function SortableReferredOutList({
	items,
}: {
	...
	return (
		<SortableList items={items} onOrderChange={updateReferredOutOrders}>
			{(sorted) =>
						...
						{({ attributes, listeners }) => (
							...
							>
								...
								<div className="flex justify-end gap-2">
									<ReferredOutFormDialog referredOut={item}>
									...
									<ActionButton
										...
										action={removeReferredOut.bind(null, item.id)}
										requireAreYouSure
									>
