...
import { RequestedServiceResponse } from "@/lib/db/queries";

export default function RequestedServicesCard() {
	...
	const query = useAggregateQuery<RequestedServiceResponse>("requestedServices", effectiveRange);
