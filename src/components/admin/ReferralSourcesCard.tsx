...
import { ReferralSourceResponse } from "@/lib/db/queries";

export default function ReferralSourcesCard() {
	...
	const query = useAggregateQuery<ReferralSourceResponse>("referralSources", effectiveRange);
